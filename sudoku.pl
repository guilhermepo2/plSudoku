...
resolver(S) :-
     sudoku(S),
    forall(member(X,S), (print(X),nl)). %condicao de escrever todos membros da solucao.
...
sudoku([[A1,A2,A3,A4,A5,A6,A7,A8,A9],
    ...
    Vars = [A1,A2,A3,A4,A5,A6,A7,A8,A9,
	    ...
	    H1,H2,H3,H4,H5,H6,H7,H8,H9,
	    I1,I2,I3,I4,I5,I6,I7,I8,I9],
    Vars ins 1..9, % as variaveis estao entre 1 e 9
    %verificando se as colunas, linhas e quadrados sao diferentes.
    %all_different -> verificar se todas variaveis sao diferentes.
    %linhas
